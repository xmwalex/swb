...
print('strategy 1 detailed')
print('since 1999')
testssreturnext(dfdayext4,dfintradict,'long')
#
print('since 2010')
dfdayl10 = dfdayext4.loc[2748:]
dfdayl10.reset_index(inplace=True,drop=True)
testssreturnext(dfdayl10,dfintradict,'long')
...
print('since 2018 5-7')
dfdayl10 = dfdayext4.loc[4820:]
dfdayl10.reset_index(inplace=True,drop=True)
testssreturnext(dfdayl10,dfintradict,'long')

    
print('strategy 2 detailed')
print('since 1999')
testssreturnext(dfdayext4,dfintradict)
#
print('since 2010')
dfdayl10 = dfdayext4.loc[2748:]
dfdayl10.reset_index(inplace=True,drop=True)
